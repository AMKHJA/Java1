...
local msg_id = msg.id
Redis:incr(BEST..'BEST:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
local Contact_Group = Redis:get(BEST.."BEST:Lock:Contact"..msg_chat_id)
...
if text  then
local test = Redis:get(BEST.."BEST:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(BEST.."BEST:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(BEST.."BEST:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(BEST.."BEST:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(BEST.."BEST:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(BEST.."BEST:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
return LuaTele.sendText(msg_chat_id,msg_id,"* ◉ تم حفظ في قائمه الردود *\n* ◉ ارسل『"..test.."』لرئية الرد*","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(BEST.."BEST:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(BEST.."BEST:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(BEST.."BEST:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(BEST.."BEST:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(BEST.."BEST:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(BEST.."BEST:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(BEST.."BEST:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(BEST.."BEST:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(BEST.."BEST:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(BEST.."BEST:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(BEST.."BEST:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(BEST.."BEST:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(BEST.."BEST:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(BEST.."BEST:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(BEST.."BEST:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(BEST.."BEST:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(BEST.."BEST:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(BEST.."BEST:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(BEST.."BEST:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(BEST.."BEST:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(BEST.."BEST:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"* ◉ تم حذف الرد في قائمه الردود *","md",true)  
return false
end
end
if text and Redis:get(BEST.."BEST:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(BEST.."BEST:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(BEST.."BEST:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(BEST.."BEST:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(BEST.."BEST:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(BEST.."BEST:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(BEST.."BEST:Add:Rd:Sudo:Video"..text)
local document = Redis:get(BEST.."BEST:Add:Rd:Sudo:File"..text)
local audio = Redis:get(BEST.."BEST:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(BEST.."BEST:Add:Rd:Sudo:video_note"..text)
if Text then 
local ban = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(BEST..'BEST:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(BEST..'BEST:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(BEST.."BEST:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(BEST.."BEST:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(BEST.."BEST:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(BEST.."BEST:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(BEST.."BEST:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(BEST.."BEST:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(BEST.."BEST:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(BEST.."BEST:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(BEST.."BEST:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(BEST.."BEST:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local ban = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(BEST..'BEST:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text then
local test = Redis:get(BEST.."BEST:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(BEST.."BEST:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(BEST.."BEST:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(BEST.."BEST:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(BEST.."BEST:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(BEST.."BEST:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(BEST.."BEST:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text and text:match("^(.*)$") then
if Redis:get(BEST.."BEST:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(BEST.."BEST:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(BEST.."BEST:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(BEST.."BEST:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text and text:match("^(.*)$") then
if Redis:get(BEST.."BEST:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(BEST..'BEST:'..v..text)
end
Redis:del(BEST.."BEST:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(BEST.."BEST:List:Rd:Sudo", text)
...
if text and Redis:get(BEST..'BEST:GetTexting:DevBEST'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '『 الغاء الامر 』' then 
Redis:del(BEST..'BEST:GetTexting:DevBEST'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ◉ تم الغاء حفظ كليشة المطور')
end
Redis:set(BEST..'BEST:Texting:DevBEST',text)
Redis:del(BEST..'BEST:GetTexting:DevBEST'..msg_chat_id..':'..msg.sender.user_id)
...
if Redis:get(BEST.."BEST:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(BEST.."BEST:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ◉ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(BEST.."BEST:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(BEST.."BEST:Name:Bot",text) 
...
--download('https://raw.githubusercontent.com/M2007A/JEKA/master/BEST.lua','BEST.lua')
...
NamesBot = (Redis:get(BEST.."BEST:Name:Bot") or "ميزو")
...
if not Redis:get(BEST.."BEST:BotFree") then
...
Redis:set(BEST.."BEST:Zhrf:Sasa"..msg_chat_id,true) 
...
Redis:del(BEST.."BEST:Zhrf:Sasa"..msg_chat_id) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*☽ عدد جهاتك يبشا ⇦ '..(Redis:get(BEST.."BEST:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
local list = Redis:smembers(BEST.."BEST:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(BEST.."BEST:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(BEST.."BEST:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(BEST.."BEST:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(BEST.."BEST:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(BEST.."BEST:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(BEST.."BEST:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(BEST.."BEST:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(BEST.."BEST:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(BEST.."BEST:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(BEST.."BEST:List:Manager"..msg_chat_id)
end
...
text = " ◉ قائمه الردود ⇧⇩\n●○━━━━‌‌‏𝑩𝑬𝑺𝑻━━━━○●\n"
for k,v in pairs(list) do
if Redis:get(BEST.."BEST:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(BEST.."BEST:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(BEST.."BEST:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(BEST.."BEST:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(BEST.."BEST:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(BEST.."BEST:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(BEST.."BEST:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ◉"
elseif Redis:get(BEST.."BEST:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(BEST.."BEST:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(BEST.."BEST:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(BEST.."BEST:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
keyboard.inline_keyboard = {
{
{text = '˹  𝒁𝑰𝑨𝑫 ⁦. 𓌗', url = "https://t.me/QQWGT"},{text = '˹  𝑻𝑾𝑨𝑺𝑶𝑳 ⁦. 𓌗', url = "https://t.me/AA_Q19bot"}
},
{
{text = '.َ ‹ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑩𝑬𝑺𝑻 ⁦⁦.𖨬', url = "https://t.me/QQWGT2"}
},
...
elseif text == 'باندا' or text == 'بندا' or text == 'banda' then
photo = "https://t.me/QQWGT"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ ᴘᴀɴᴅᴀ \n ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '.َ ‹ＢＡＮＤＡ‏𝙓⃟🇨🇭', url = "https://t.me/QQWGT"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'ميزو' or text == 'ميزوو' or text == 'يا ميزو' then
photo = "https://t.me/BEST508"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ ˹  𝑩𝑬𝑺𝑻 ⁦. 𓌗 \n ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '˹  𝑩𝑬𝑺𝑻 ⁦. 𓌗', url = "https://t.me/BEST508"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'زياد' or text == 'الزوز' or text == 'زوز' then
photo = "https://t.me/A_N_T_N_O_l"
local Name = 'ᴘʀᴏɢʀᴀᴍᴍᴇʀ ᴘᴀɴᴅᴀ \n ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, \nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𝅘𝅥𝅯 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '˹  𝒁𝑰𝑨𝑫 ⁦. 𓌗', url = "https://t.me/A_N_T_N_O_l"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
return LuaTele.sendText(msg_chat_id,msg_id,'◉ اليك قسم الالعاب من سورس ميزو ◉',"md",false, false, false, false, reply_markup)
end
if text == 'تحديث' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ◉ هاذا الامر يخص 『 '..Controller_Num(1)..' 』* ',"md",true)  
...
Redis:setex(BEST.."BEST:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
if text == (Redis:get(BEST.."BEST:Name:Bot") or " ") then
local NamesBot = (Redis:get(BEST.."BEST:Name:Bot") or " ")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n ◉ أهلآ بك في بوت '..(Redis:get(BEST.."BEST:Name:Bot") or "ميزو")..
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'ࢪجۅْع͜', data =UserId..'/'.. 'NoNextSeting'},},}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'ࢪجۅْع͜', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BEST.."BEST:Sasa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'ࢪجۅْع͜', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(BEST.."BEST:photo:Rank"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'ࢪجۅْع͜', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BEST.."BEST:Sasa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'ࢪجۅْع͜', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(BEST.."BEST:photo:Rank"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'ࢪجۅْع͜', data =UserId..'/'.. 'listallAddorrem'},},}}
...
{
{text = 'ࢪجۅْع͜', data =IdUser..'/'.. 'NoNextSeting'}
},
{
{text = '◉ القائمه الرئيسيه ◉', data = IdUser..'/helpall'},
},
...
{
{text = 'ࢪجۅْع͜', data =UserId..'/'.. 'NoNextSeting'},
},
}
}
